...
public class DBContact extends DBStrukt 
{
    ...
    public static final DBString  EMAIL             = new DBString("email", 1);
    public static final DBString  BANK_ACCOUNT_IBAN = new DBString("bank_account_iban", 1);
    public static final DBString  BANK_ACCOUNT_BIC  = new DBString("bank_account_bic", 1);
