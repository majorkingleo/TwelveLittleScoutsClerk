/**
 * TwelveLittleScoutsClerk Dialog for AccountClasses table
...
public class AccountClasses extends BaseDialog implements NewSequenceValueInterface {

    MainWin mainwin;
    List<DBAccountClasses> values;
    TableManipulator tm;

    public AccountClasses(MainWin mainwin) {
        super(mainwin.getRoot(), "Account Classes");

        initComponents();

        this.mainwin = mainwin;

        DBAccountClasses accClass = new DBAccountClasses();

        tm = new TableManipulator(root, jTContent, accClass);

        tm.hide(accClass.hist.lo_user);
        tm.hide(accClass.hist.lo_zeit);
    ...
    private void feed_table(boolean autombox) {
        new AutoMBox(getTitle(), autombox) {
            ...
            public void do_stuff() throws Exception {
                ...
                DBAccountClasses accClass = new DBAccountClasses();
                values = trans.fetchTable2(accClass, " where "
                        + trans.markColumn(accClass, accClass.bp_idx) + " = "
                        + mainwin.getBPIdx());

                for (DBAccountClasses entry : values) {
                    tm.add(entry);
                }
            }
        };
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Account Classes");
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        AutoMBox al = new AutoMBox(getTitle()) {
            ...
            public void do_stuff() throws Exception {
                ...
                DBAccountClasses entry = values.get(i);
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        AutoMBox al = new AutoMBox(AccountClasses.class.getName()) {
    ...
    private void jBEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditActionPerformed
        ...
        final EditAccountClasses editDialog = new EditAccountClasses(mainwin, values.get(i));
        editDialog.registerOnCloseListener(new Runnable() {

            @Override
            public void run() {

                new AutoMBox(AccountClasses.class.getName()) {
