/**
 * TwelveLittleScoutsClerk Dialog for BillTemplate table
...
public class BillingTemplate extends BaseDialog implements NewSequenceValueInterface {

    MainWin mainwin;
    List<DBBillTemplate> values;
    TableManipulator tm;
    ...
    public BillingTemplate(MainWin mainwin) {
        ...
        tm = new TableManipulator(root, jTContent, tmpl);

        tm.hide(tmpl.hist.lo_user);
    ...
    private void feed_table(boolean autombox) {
        new AutoMBox(getTitle(), autombox) {
            ...
            public void do_stuff() throws Exception {
                ...
                DBBillTemplate tmpl = new DBBillTemplate();
                values = trans.fetchTable2(tmpl, " where "
                        + trans.markColumn(tmpl, tmpl.bp_idx) + " = "
                        + mainwin.getBPIdx());

                for (DBBillTemplate entry : values) {
                    tm.add(entry);
                }
            }
        };
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        AutoMBox al = new AutoMBox(getTitle()) {
            ...
            public void do_stuff() throws Exception {
                ...
                DBBillTemplate entry = values.get(i);
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        AutoMBox al = new AutoMBox(BillingTemplate.class.getName()) {
    ...
    private void jBEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditActionPerformed
        ...
        final EditBillingTemplate editDialog = new EditBillingTemplate(mainwin, values.get(i));
        editDialog.registerOnCloseListener(new Runnable() {

            @Override
            public void run() {

                new AutoMBox(BillingTemplate.class.getName()) {
    ...
    private void newEntry() throws SQLException, UnsupportedDBDataTypeException, WrongBindFileFormatException, TableBindingNotRegisteredException, IOException {
        ...
        DBBillTemplate entry = new DBBillTemplate();
        entry.bp_idx.loadFromCopy(mainwin.getBPIdx());
        entry.idx.loadFromCopy(mainwin.getNewSequenceValue(DBBillTemplate.BILL_TEMPLATE_IDX_SEQUENCE));

        CreateBillingTemplate createDialog = new CreateBillingTemplate(mainwin, this, entry);

        invokeDialogModal(createDialog);

        if (createDialog.pressedSave()) {
