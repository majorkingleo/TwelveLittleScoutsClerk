/**
 * TwelveLittleScoutsClerk Create dialog for BillTemplate
...
public class CreateBillingTemplate extends BaseDialogDialog {
    ...
    private void jBUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBUploadActionPerformed
        ...
        new AutoMBox(CreateBillingTemplate.class.getName()) {
            @Override
